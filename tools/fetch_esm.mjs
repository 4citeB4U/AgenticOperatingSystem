const urls = [
  'http://localhost:3000/models/qwen2.5-0.5b-instruct/config.json',
  'http://localhost:3000/models/qwen2.5-0.5b-instruct/onnx/model.onnx',
  'http://localhost:3000/onnx/ort-wasm-simd.wasm'
];
